...
include 'CheckoutInterface.php';
include 'RealCheckout.php';
include 'CheckoutProxy.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $realCheckout = new RealCheckout($conn);
    $checkoutProxy = new CheckoutProxy($realCheckout);

    $checkoutProxy->processCheckout($userData, $cartData);
}
?>
